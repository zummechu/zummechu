      ...
      <main className="mx-auto mt-7 px-5 min-h-[78.4vh] flex flex-col justify-start">
        <div className="flex-grow">
          <div className="flex justify-between mb-3 items-end">
            <p className="font-bold text-xl ">면 종류 중에 어떤거?</p>
          </div>
          <div className="w-84 h-[auto] flex flex-wrap justify-between gap-1 items-center">
            ...
            >
              <div className="mt-1 flex flex-col justify-center items-center">
                <p className="items-center font-medium text-lg">짜장</p>
              </div>
              <div>
                <div className="">
                  <Select
            ...
            >
              <div className="mt-1 flex flex-col justify-center items-center">
                <p className="items-center font-medium text-lg">짬뽕</p>
              </div>
              <div>
            ...
            >
              <div className="mt-1 flex justify-center items-center">
                <p className="items-center font-medium text-lg">파스타</p>
              </div>
              <div>
                <Select
                  className="w-6 h-6"
            ...
            <div
              className={`flex justify-between items-center px-5 cursor-pointer w-84 h-16 border rounded-[1.25rem] py-6 relative ${
                selectedItem === 3 ? "bg-selected" : ""
              }`}
              onClick={() => handleItemClick(3)}
            >
              <div className="mt-1 flex flex-col justify-center items-center">
                <p className="items-center font-medium text-lg">잔치국수</p>
              </div>
              <div>
                <div className="flex justify-center items-center">
                  <Select
